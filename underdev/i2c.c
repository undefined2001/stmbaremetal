...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
    ...
    if (pI2CHandle->I2C_Config.I2C_SCLSpeed <= I2C_SCL_SPEED_SM)
    {
        ...
        ccr_value = (GetAPB1Clock() / (2 * pI2CHandle->I2C_Config.I2C_SCLSpeed));
    ...
    else
    {
        ...
        {
            ccr_value = (GetAPB1Clock() / (3 * pI2CHandle->I2C_Config.I2C_SCLSpeed));
        }
        else
        {
            ccr_value = (GetAPB1Clock() / (25 * pI2CHandle->I2C_Config.I2C_SCLSpeed));
        }
        tempreg |= (ccr_value & 0xFFF);
    }
    ...
    if (pI2CHandle->I2C_Config.I2C_SCLSpeed <= I2C_SCL_SPEED_SM)
    {
        ...
        tempreg = (GetAPB1Clock() / 1000000U) + 1;
    }
    else
    {
        // mode is fast mode
        tempreg = ((GetAPB1Clock() * 300) / 1000000000U) + 1;
    }
